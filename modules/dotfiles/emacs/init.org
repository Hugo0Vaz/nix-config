...
1. `C-c c L` - capture de log no logbook global
2. `C-c c T` - capture de todo na nota diária
3. `C-c c t` - capture de todo na nota de todo global
4. `C-c c n` - capture de nota
...
*** DONE função para gerar o path da nota diária
...
*** TODO função para criar a daily_note do dia se não existe
*** TODO função para o capture de log na nota diária
*** TODO função para o capture de todo na nota diária
*** TODO função para abrir a nota diária
*** TODO função para abrir a próxima nota diária se o atual buffer é uma daily note
*** TODO função para abrir a notá diária prévia se o atual buffer é uma daily note
